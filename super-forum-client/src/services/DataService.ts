...
export async function getThreadByCategory (catID: string) : Promise<Array<Thread>>{
    const promise = new Promise<Array<Thread>>((res, rej) => {
        setTimeout(()=>{
            ...
            threads.push({
                ...
                user: new User("1", "dave@gmail.com", "dave"),
                points : 11,
                createdOn: new Date(),
                lastModifiedOn: new Date(),
                threadItems : [{ //for reply 
                    id: "1",
                    views : 22, 
                    points: 2,
                    body : "ThreadItem 1",
                    user: new User("2", "test2@gmail.com", "jon"),
                    createdOn: new Date(),
                    threadId: "1",
                },],
            ...
            threads.push({
                ...
                title : "Thread 2",
                body : "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
                user: new User("2", "tim@mail.com", "2"),
                points: 55,
                createdOn : new Date(),
                lastModifiedOn: new Date(),
                threadItems : [
                    {
                        ...
                        points: 2,
                        body: "ThreadItem 1",
                        user: new User ("2", "tim@gmail.com", "tim"),
                        createdOn: new Date(),
                        threadId:  "2"
                    },
                ],
...
export async function getThreadById(Id: string) : Promise<Thread> {
    const promise = new Promise<Thread>((res, req) =>{
        setTimeout(()=>{
            const thread = {
                id: "1",
                views: 22, 
                title: "Thread 1",
                body : "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
                user: new User ("1", "dave@mail.com", "dave"),
                points : 11,
                createdOn: new Date(),
                lastModifiedOn: new Date(),
                threadItems: [
                    {
                        ...
                        points: 2,
                        body: "ThreadItem 1",
                        user: new User("2", "jon@mail.com", "jon"),
                        createdOn: new Date(),
                        threadId: "1",
                    },
                    {
                        ...
                        points: 14,
                        body: "ThreadItem 2",
                        user: new User("4", "linda@mail.com", "linda"),
                        createdOn: new Date(),
                        threadId: "1",
                    },
                ],
    ...
    const result = new Promise<Array<Thread>>((res) =>{
        setTimeout(()=>{
            ...
            threads.push({
                ...
                title: "Thread 2",
                body: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
                user: new User("2", "tim@mail.com", "tim"),
                points: 55,
                createdOn: new Date(),
                lastModifiedOn: new Date(),
                threadItems: [
